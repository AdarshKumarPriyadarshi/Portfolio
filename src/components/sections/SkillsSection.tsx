...
export interface SkillsContextType { // Add export here
...
const SkillsSection = () => {
  ...
  return (
    <SkillsContext.Provider value={{ activeSkill, setActiveSkill }}>
      <section id="skills" ref={sectionRef} className="section py-16 md:py-24 bg-bg-primary">
        <div className="max-w-6xl mx-auto w-full px-4">
          <h2 ref={titleRef} className="section-title text-3xl md:text-4xl font-bold text-text-primary text-center mb-8 md:mb-12">
            My <span className="text-accent-primary">Skills</span>
          </h2>

          <div className="mt-8 md:mt-12">
            <p className="text-base md:text-lg text-text-secondary text-center mb-8 max-w-3xl mx-auto">
            ...
            <div ref={panelsRef} className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-8">
            ...
            {activeSkill && (
              <div className="mt-8 p-4 border border-accent-primary bg-bg-primary bg-opacity-20 text-center ">
                <p className="text-text-primary">
                  <span className="font-bold text-accent-primary">{activeSkill}</span> is selected. 
